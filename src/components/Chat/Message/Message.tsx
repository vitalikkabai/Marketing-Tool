...
const Message: React.FC<PropTypes> = (props) => {
    ...
    return (
        <Box className={classes.bubbleWrapper}>
            ...
            <div className={props.senderId !== props.userId ? classes.senderContainer : classes.recipientContainer}>
                ...
                <div className={classes.bubble}>
                    ...
                    <div className={classes.messageTime}>
                        ...
                        <CheckMark className={classes.checkSVG + " " + (props.status === "RECEIVED" ? styles.receivedCheck :
                            styles.sentCheck)}/>
                    </div>
                </div>
            </div>
