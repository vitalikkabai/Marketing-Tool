                    ...
                    <Grid container className={classes.formContent}>
                        <Grid item xs={12} className={classes.formInputs}>
                            ...
                            <Grid xs={12} item className={classes.productInfoInputs}>
                                <Box style={{width:"20%", marginRight: "24px"}}>
                                    <CustomInput label={"Item №"} fullWidth/>
                                </Box>
                                <Box style={{width:"30%", marginRight: "24px"}}>
                                    <CustomInput label={"Item name"} fullWidth/>
                                </Box>
                                <Box style={{width:"20%"}}>
                                    <CustomInput label={"Release"} fullWidth/>
                                </Box>
                                <Box style={{width:"30%", marginLeft: "48px"}}>
                                    <CustomInput label={"Tag"} fullWidth/>
                                </Box>
                            </Grid>
                            <Grid xs={12} item className={classes.productUrlInputs}>
                                <CustomInput label={"URL"} fullWidth/>
                                <Typography color={"primary"} className={classes.addUrlText} variant={"h6"}>+ Add URL</Typography>
                            </Grid>
                            <Grid xs={12} item className={classes.additionalInfo}>
                                <Box style={{width:"30%"}}>
                                    <CustomInput label={"Color"} fullWidth/>
                                    <Typography color={"primary"} className={classes.addUrlText} variant={"h6"}>+ Add Color</Typography>
                                </Box>
                                <Box style={{width:"40%", margin: "0 48px"}}/>
                                <Box style={{width:"30%"}}>
                                    <CustomInput label={"Material"} fullWidth/>
                                    <Typography color={"primary"} className={classes.addUrlText} variant={"h6"}>+ Add Material</Typography>
                                </Box>
                            </Grid>
                        </Grid>
                        <Grid item container xs={12} className={classes.nextButtonBox}>
                            <CustomButton type={"submit"} text={"Next"} borderRadius={"10px"}/>
                        </Grid>
                    </Grid>
                </form>
            </Grid>
