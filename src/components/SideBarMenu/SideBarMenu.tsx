		...
		<Grid container direction={"column"} alignItems={"flex-start"} className={classes.menu}>
			...
			>
				<ListItem button
					...
					<ListItemText primary={<Typography variant={selected === "1" || hovered === "1" ? "h6" : "subtitle1"}>Dashboard</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					onClick={
						() => {
							setSelected("2");
							props.isAuth ? history.push('/products') : history.push('/preview/products');
						}
					}>
					<ListItemIcon classes={{ root: classes.listIconRoot }}>
						<BoxIcon className={classes.svgIcon} />
					</ListItemIcon>
					<ListItemText primary={<Typography variant={selected === "2" || hovered === "2" ? "h6" : "subtitle1"}>Products</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					onClick={
						() => {
							setSelected("3");
							props.isAuth ? history.push('/market-research') : history.push('/preview/market-research');
						}
					}>
					<ListItemIcon classes={{ root: classes.listIconRoot }}>
						<ListIcon className={classes.svgIcon} />
					</ListItemIcon>
					<ListItemText primary={<Typography variant={selected === "3" || hovered === "3" ? "h6" : "subtitle1"}>Market Research</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					onClick={
						() => {
							setSelected("4");
							props.isAuth ? history.push('/brand-creation') : history.push('/preview/brand-creation');
						}
					}>
					<ListItemIcon classes={{ root: classes.listIconRoot }}>
						<EditIcon className={classes.svgIcon} />
					</ListItemIcon>
					<ListItemText primary={<Typography variant={selected === "4" || hovered === "4" ? "h6" : "subtitle1"}>Brand Creation</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					<ListItemText primary={<Typography variant={selected === "5" || hovered === "5" ? "h6" : "subtitle1"}>Sales Channels</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					<ListItemText primary={<Typography variant={selected === "6" || hovered === "6" ? "h6" : "subtitle1"}>Customer Support</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					onClick={
						() => {
							setSelected("7");
							props.isAuth ? history.push('/brand-awareness') : history.push('/preview/brand-awareness');
						}
					}>
					<ListItemIcon classes={{ root: classes.listIconRoot }}>
						<SpeakIcon className={classes.svgIcon} />
					</ListItemIcon>
					<ListItemText primary={<Typography variant={selected === "7" || hovered === "7" ? "h6" : "subtitle1"}>Brand Awareness </Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					<ListItemText primary={<Typography variant={selected === "8" || hovered === "8" ? "h6" : "subtitle1"}>Sales Statistics</Typography>} />
				</ListItem>
				...
				<ListItem button
					...
					<ListItemText primary={<Typography variant={selected === "9" || hovered === "9" ? "h6" : "subtitle1"}>Improvements</Typography>} />
				</ListItem>
			</List>
